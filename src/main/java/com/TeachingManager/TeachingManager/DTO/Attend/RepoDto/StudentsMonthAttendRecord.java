...
//    private String lecture_name; //강의명
    ...
    public StudentsMonthAttendRecord(Long student_id, Byte attendance, LocalDateTime start_date){
...
//    public StudentsMonthAttendRecord(Long student_id,String lecure_name, Byte attendance, LocalDateTime start_date){
//        this.attendance = attendance;
//        this.student_id = student_id;
//        this.start_date = start_date;
